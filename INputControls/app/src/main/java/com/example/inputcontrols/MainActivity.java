        ...
        sp_district.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                switch (position){
                    ...
                    case 1:
                        ArrayAdapter<CharSequence> atp_Mandals = ArrayAdapter.createFromResource(MainActivity.this,R.array.Ananthapur_Mandals,
                                        android.R.layout.simple_spinner_item);
                        sp_mandal.setAdapter(atp_Mandals);
                        break;
                    case 2:
                        ArrayAdapter<CharSequence> knl_Mandals =
                                ArrayAdapter.createFromResource(MainActivity.this,R.array.Ananthapur_Mandals,
                                        android.R.layout.simple_spinner_item);
